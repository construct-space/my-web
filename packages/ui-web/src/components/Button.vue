...
const colorVariantClasses = computed(() => {
  ...
  if (v === 'ghost') {
    ...
    if (c === 'primary') return 'bg-transparent text-[var(--app-accent)] hover:bg-[color-mix(in_srgb,var(--app-accent)_10%,transparent)]'
  ...
  // Soft variant
  if (v === 'soft') {
    if (c === 'primary') return 'bg-[color-mix(in_srgb,var(--app-accent)_15%,transparent)] text-[var(--app-accent)] hover:bg-[color-mix(in_srgb,var(--app-accent)_25%,transparent)]'
